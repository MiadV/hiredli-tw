      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="relative inline-block w-full max-w-md rounded-xl shadow-lg p-6 bg-white dark:bg-gray-800 ">
                <span className="flex w-[140px] mx-auto ">
                  <Logo />
                </span>
                <Tab.Group>
                  <Tab.List className="mt-4 flex rounded-lg bg-indigo-100 overflow-hidden">
                    <Tab
                      className={({ selected }) =>
                        clsx(
                          'w-full py-2.5 leading-5 font-medium ',
                          selected
                            ? 'bg-white border-b-4 border-indigo-800'
                            : 'text-slate-500'
                        )
                      }
                    >
...
const SignInForm = () => {
  return (
    <div className="px-10 pt-4 pb-4 rounded-tr-4xl">
      ...
      >
        <div className="relative">
          <input
            ...
            name="email"
            type="text"
            className="peer h-10 w-full border-b-2 border-slate-400 text-gray-900 placeholder-transparent focus:ring-0 focus:border-b-2 focus:border-indigo-400 "
      ...
      <a
        href="#"
        className="block mt-4 hover:text-indigo-800 dark:text-gray-300 dark:hover:text-white hover:underline transition-all duration-150"
      >
