...
export const Footer = () => {
  return (
    <footer className='bg-white dark:bg-slate-900 mt-20'>
      <div className='max-w-screen-xl mx-auto px-6 sm:px-8 pt-16'>
        <div className='grid grid-cols-1 xs:grid-cols-2 md:!grid-cols-6 gap-y-6 gap-x-6 md:gap-8'>
          <div className='xs:col-span-2  flex flex-col mb-4'>
            <span className='capitalize text-xl font-bold'>Hiredli</span>
            <p className='text-sm max-w-screen-xs mt-4'>
              ...
              {SocialLinks.map((item) => (
                <li key={item.title}>
                  <a
                    ...
                    className='dark:fill-white hover:fill-indigo-800 dark:hover:fill-indigo-800 transition-all duration-150'
                  >
                    {item.Icon}
                  </a>
                </li>
            ...
            <span className='capitalize text-xl font-bold mt-8'>
              ...
              <div key={title}>
                ...
                <ul className='mt-4 space-y-2'>
                  {items.map((item) => (
                    <li key={item.title}>
                      <Link href={item.href}>
                        <a className='hover:text-indigo-800 dark:text-gray-300 dark:hover:text-white hover:underline transition-all duration-150'>
                          {item.title}
                        </a>
                      </Link>
                    </li>
        ...
        <div
          id='footer-copyright'
          className='py-4 mt-2 border-t border-slate-200 dark:border-slate-600'
        >
